...
class GameView extends SubView {
    ...
    private void writeInteger(int number) {
        this.console.write(Integer.toString(number));
    }

    private void writelnInteger(int number) {
        this.console.writeln(Integer.toString(number));
    }
